...
<body class="h-screen bg-cover bg-no-repeat bg-blend-multiply bg-[#00122C]/50 backdrop-blur-sm mb-10"
style="background-image: url('assets/bg add boat.jpg');">

<section class="w-full p-8 backdrop-blur-sm flex flex-row gap-4 overflow-hidden">
