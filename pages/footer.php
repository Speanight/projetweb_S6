      ...
      <div class="w-full px-4 lg:w-3/20 min-w-[160px]">
        <div class="w-full ml-10">
          ...
          <div class="mb-6 flex items-center">
            <a href="/about" class="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-primary hover:text-slate-400 sm:mr-4 lg:mr-3 xl:mr-4">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                  <path stroke-linecap="round" stroke-linejoin="round" d="m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z" />
              </svg>
            </a>
            <a href="https://github.com/Speanight/projetweb_S6" target="_blank" class="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-primary hover:bg-primary hover:text-slate-400 sm:mr-4 lg:mr-3 xl:mr-4 ">
              <span width="16" height="12" viewBox="0 0 16 12" class="fill-current material-symbols-outlined">commit</span>
            </a>
            <a href="https://isen-ouest.fr/" target="_blank" class="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-primary hover:bg-primary hover:text-slate-400 sm:mr-4 lg:mr-3 xl:mr-4">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
